...
<div class="container">
    ...
    <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                <div class="card movie-card shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="small text-muted mb-1">Sortie prévue : <?= htmlspecialchars(formatDateFr($movie['release_date'] ?? null)); ?></p>
        ...
        <?php if (empty($movies)): ?>
            <div class="col-12">
                <div class="alert alert-warning">Aucun film à venir trouvé.</div>
            </div>
        <?php endif; ?>
    </div>
</div>

...
<div class="container">
    <div class="hero">
        <h1>Derniers films mis à jour</h1>
        <p class="text-muted mb-0">Films récemment sortis / mis à jour sur TMDB (catégorie "now playing").</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <?php if (empty($movies)): ?>
            <div class="col-12">
                <div class="alert alert-warning">Aucun film disponible pour le moment.</div>
            </div>
        <?php endif; ?>
    </div>
</div>
